...
import '../styles/Donor criteria.css';
  ...
  return (
    <div className="donor-criteria">
      ...
      <p className="donor-criteria1">Donor Criteria</p>
        <p className="be-sure-to"> Be sure to be eligible to donate your blood.</p>
      </div>
      {/* main content */}
      <div className="in-the-past-container content">
        <div className='text'><span className="in-the-past">In the past 1 year, </span>
        <span>
      ...
      <div className="in-the-past-container content">
       <div className='text'> <span className="in-the-past">In the past 6 months,</span>
      ...
      <div className='text'>
        ...
        <span>I had immunisations.</span></div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
      <div className='text'>
        <span className="in-the-past">In the past 3 months,</span>
        <span> I donated blood or been treated for Malaria.</span></div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
        <div className='text'>
        <span className="in-the-past">{`In the past 24h, `}</span>
        <span>I had an alcoholic beverage.</span></div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
        <div className='text'>
        <span className="in-the-past">{`Presently, `}</span>
        <span>I’m pregnant or breast feeding my child.</span></div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
      ...
      <div className="in-the-past-container content">
        <div className='text'>
        My body weight is not less than 45kg.</div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
        <div className='text'>
      ...
      <div className="in-the-past-container content">
        <div className='text'>
        <span className="in-the-past">{`Presently, `}</span>
        <span>I am menstruating.</span></div>
        <Donoricon />
      </div>
      <div className="in-the-past-container content">
        <div className='text'>
...
function Donoricon() {
  return (
    <div className='markicon'>
      <button><CheckIcon sx={{ fontSize: 41 }} className='DonorIcon' /></button>
      <button><CloseIcon sx={{ fontSize: 41 }} className='DonorIcon' /></button>
    </div>
  )
}
